...
@RequestMapping(value = WebConstants.DEFAULT_API_PREFIX
		+ "/scoreexchange", produces = WebConstants.DEFAULT_REQUEST_PRODUCES)
public class ScoreExchangeController
		extends AbstractDataController<Long, ScoreExchange, ScoreExchangeDao, IScoreExchangeService> {
	...
	public List<ScoreMinScoreDto> scoreExgSummary() {
		return this.getService().scoreExgSummary();
	}
